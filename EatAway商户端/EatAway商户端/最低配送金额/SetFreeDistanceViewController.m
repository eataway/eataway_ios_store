//
//  SetFreeDistanceViewController.m
//  EatAway商户端
//
...
#import "SetFreeDistanceViewController1.h"


@interface SetFreeDistanceViewController1 ()<UITextFieldDelegate>
{
    UITextField *TFContent;
}
@end

@implementation SetFreeDistanceViewController1
...
-(void)btnDoneClick
{
    ...
    {
        [self.delegate SetFreeDistance:TFContent.text];
        [self.view removeFromSuperview];
    }
}
-(void)btnDeleteClick
{
    [self.delegate deleteFreeDistance];
    [self.view removeFromSuperview];
}
