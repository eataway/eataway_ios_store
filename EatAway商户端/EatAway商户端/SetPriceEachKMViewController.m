//
//  SetPriceEachKMViewController.m
//  EatAway商户端
//
...
@interface SetPriceEachKMViewController ()<UITextFieldDelegate>
{
    UITextField *TFContent;
}
@end

@implementation SetPriceEachKMViewController
...
-(void)btnDoneClick
{
    ...
    {
        [self.delegate SetPriceEachKM:TFContent.text];
        [self.view removeFromSuperview];
    }
}
