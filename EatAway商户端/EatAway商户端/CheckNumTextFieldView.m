...
@implementation CheckNumTextFieldView
...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _textField = [[UITextField alloc]initWithFrame:CGRectMake(10 + 25 + 10, 10, frame.size.width - (10 + 25 + 10 + 130 + 10), 25)];
        _textField.font = [UIFont systemFontOfSize:13];
        [self addSubview:_textField];
        
        _button = [UIButton buttonWithType:UIButtonTypeCustom];
        _button.frame = CGRectMake(viewBG.frame.size.width - 130, 0, 130, frame.size.height);
        _button.backgroundColor = [UIColor colorWithWhite:204/255.0 alpha:1];
        [_button setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        _button.titleLabel.font = [UIFont systemFontOfSize:13];
        [viewBG addSubview:_button];
